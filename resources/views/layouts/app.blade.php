...
<html lang="id">
    ...
    <body>
        <div class="app-container">
            <!-- Sidebar Navigation -->
            <aside class="sidebar">
                <div class="sidebar-header" style="margin-bottom: 32px; padding: 0 8px;">
                ...
                <nav class="nav-menu">
                    ...
                    <a href="{{ route('dashboard.operational') ?? '#' }}" class="nav-item {{ request()->routeIs('dashboard.operational') ? 'active' : '' }}">
                        ...
                        @auth
                            <div class="user-chip">
                                <div>
                                    ...
                                    <span>{{ auth()->user()->role === \App\Models\User::ROLE_SUPERADMIN ? 'Superadmin' : 'Pengguna' }}</span>
                                </div>
