...
@section('content')
    ...
    @if ($summary['pending_request_count'] > 0 && auth()->user()->hasPermission(\App\Models\RolePermission::PERMISSION_REQUESTS_MANAGE))
        <div class="notice-box fade-in-up" style="margin-bottom: 24px; border-left: 4px solid var(--warning-text); background-color: var(--warning-soft); padding: 16px;">
            <div style="display: flex; align-items: center; gap: 8px;">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" style="width:24px;height:24px;color:var(--warning-text)"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"></path></svg>
                <strong>Notifikasi Langsung</strong>
            </div>
            <p style="margin-top: 8px;">Terdapat <strong>{{ $summary['pending_request_count'] }}</strong> permintaan barang yang menunggu persetujuan. Silakan tinjau dan proses permintaan tersebut.</p>
            <div style="margin-top: 12px;">
                <a href="{{ route('permintaan-barang.index') }}" class="button-secondary" style="padding: 6px 12px; font-size: 0.85rem;">Lihat Permintaan</a>
            </div>
        </div>
    @endif
